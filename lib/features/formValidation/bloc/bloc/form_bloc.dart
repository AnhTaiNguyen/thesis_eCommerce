...
import '../../../authentication/application/authentication_repository.dart';
import '../../../authentication/data/database_repository_impl.dart';
import '../../../authentication/domain/userModel.dart';
    ...
    if (state.isFormValid) {
      try {
        ...
        UserModel updatedUser = user.copyWith(
            id: authUser!.user!.uid, isVerified: authUser.user!.emailVerified);
