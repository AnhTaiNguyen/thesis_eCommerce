...
import '../../../formValidation/bloc/bloc/form_bloc.dart';
import '../../../formValidation/signupView.dart';
import '../../application/blocs/auth/authentication_bloc_bloc.dart';
        ...
        BlocListener<AuthenticationBloc, AuthenticationBlocState>(
          listener: (context, state) {
            if (state is AuthenticationSuccess) {
              if (kDebugMode) {
                print('AuthenticationSuccess state received.');
                print(state);
              }
              Navigator.pushNamed(
                context,
        ...
        return SizedBox(
          ...
          child: TextFormField(
              ...
              decoration: InputDecoration(
                labelText: 'Email',
                helperText:
                    'A complete, valid email e.g. loveshopping@gmail.com',
